...
def open_calendar(parent, entry_widget, search_callback):
    ...
    month_combobox.bind("<<ComboboxSelected>>", update_calendar)  # Triggered when the user selects an item
    year_combobox.bind("<<ComboboxSelected>>", update_calendar)  # Triggered when the user selects an item
    ...
    def select_date():
        ...
        search_callback()  # Trigger the search function
